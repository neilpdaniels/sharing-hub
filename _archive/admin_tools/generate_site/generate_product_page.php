	              ...
	              <td><div id="wrapper"> <!-- This should really be class -->
	                  <div id="wrapper<?php echo $counter; ?>">
	                    <table width="100%" border="0" padding="0" id="bid_width">
	                      <tr style="cursor:pointer" onClick="showGrid(<?php echo $counter.\', \'.$value; ?>);" onMouseOver="wrapper<?php echo $counter; ?>.style.background=\'white\';" onMouseOut="wrapper<?php echo $counter; ?>.style.background=\'rgb(250, 250, 250)\';" title="click to show/hide order details">
