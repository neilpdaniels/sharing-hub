...
<form id="nonAbstractDetails" name="nonAbstractDetails" method="post" action="<?php $_SERVER['PHP_SELF']; ?>">
	...
	category id: <textarea name="description" cols="20" rows="1"></textarea><br/>
	...
	<input type="button" value="Add picture" onClick="javascript:popupNew('addNACategoryAddPicture.php?nacat_id='+document.forms['nonAbstractDetails'].elements['description'].value, 250, 475);"><br>
