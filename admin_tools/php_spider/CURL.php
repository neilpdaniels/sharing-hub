...
function doRequest($method, $url, $vars) {
   ...
   curl_setopt($ch, CURLOPT_USERAGENT, 'Bosbo price bot - manually run - http://www.bosbo.co.uk/');
...
function get($url) {
   return $this->doRequest('GET', trim($url), 'NULL');
}

function post($url, $vars) {
   return $this->doRequest('POST', trim($url), $vars);
}
}
?>
