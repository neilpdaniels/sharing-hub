            ...
            attributes=[
                {
                    ...
                    'filterable': True,
                    'sortable': True,
                    'allowed_values': ['3x3m', '4x3m', '4x4m', '6x3m', '6x4m', '8x4m'],
                    'value_source': 'product',
                },
            ],
            products=make_products(
                [
                    {'name': 'Marquee 6x3m', 'attributes': {1: '6x3m'}},
                    {'name': 'Marquee 8x4m', 'attributes': {1: '8x4m'}},
                    {'name': 'Marquee 6x4m', 'attributes': {1: '6x4m'}},
                    {
                        'name': 'Pop-up gazebo',
                        'extra_categories': ['Gazebos, awnings and shade'],
                        'attributes': {1: '3x3m'},
                    },
                    {'name': 'Clearspan marquee 4x4m', 'attributes': {1: '4x4m'}},
                    {'name': 'Stretch tent 6x4m', 'attributes': {1: '6x4m'}},
                    {'name': 'Pagoda tent 4x4m', 'attributes': {1: '4x4m'}},
                    {'name': 'Market stall gazebo 3x3m', 'attributes': {1: '3x3m'}, 'extra_categories': ['Gazebos, awnings and shade']},
                    {'name': 'Walkway canopy 6x3m', 'attributes': {1: '6x3m'}},
                    'Sidewall set',
                    'Marquee heater',
                    'Event flooring',
                    'Entrance matting',
            ...
            attributes=[
                {
                    ...
                    'filterable': True,
                    'sortable': True,
                    'allowed_values': ['3x3m', '4x3m', '4x4m', '6x3m', '6x4m'],
                    'value_source': 'product',
                },
            ],
            products=make_products(
                [
                    {'name': 'Gazebo 3x3m', 'attributes': {1: '3x3m'}},
                    {'name': 'Gazebo 4x3m', 'attributes': {1: '4x3m'}},
                    {'name': 'Gazebo 4x4m', 'attributes': {1: '4x4m'}},
                    {'name': 'Sail shade 3x3m', 'attributes': {1: '3x3m'}},
                    {'name': 'Garden pergola 6x3m', 'attributes': {1: '6x3m'}},
                    {'name': 'Patio awning 4x3m', 'attributes': {1: '4x3m'}},
                    {'name': 'Parasol set', 'attributes': {1: '3x3m'}},
                    {'name': 'Beach shelter', 'attributes': {1: '3x3m'}},
                    {'name': 'Windbreak set'},
                    {'name': 'Camping awning 4x4m', 'attributes': {1: '4x4m'}},
                    {'name': 'Outdoor screen divider'},
                ],
