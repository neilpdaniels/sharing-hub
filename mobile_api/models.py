...
class MobileDevice(models.Model):
    ...
    notify_transaction_enquiry = models.BooleanField(default=True)
    notify_transaction_messages = models.BooleanField(default=True)
    notify_in_app_alerts = models.BooleanField(default=True)
