...
urlpatterns = [
    ...
    path('browse/<slug:cat_slug>/delete/', views.delete_category, name='delete_category'),
    path('product_page/<slug:product_slug>/delete/', views.delete_product, name='delete_product'),
