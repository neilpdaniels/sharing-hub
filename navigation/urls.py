...
urlpatterns = [
    ...
    path('sharing_hub_developer_program/', views.developerProgram, name='developerProgram'),
    path('buyer_seller_protrection/', views.escrowInformation, name='escrowInformation'),
