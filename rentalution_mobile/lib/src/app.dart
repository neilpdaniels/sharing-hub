...
void runRentalutionMobile() {
  ...
  final authRepository = AuthRepository(
    apiClient: apiClient,
    websiteApiClient: websiteApiClient,
  ...
  final friendsRepository = FriendsRepository(apiClient: apiClient);

  runApp(
    RentalutionMobileApp(
...
class RentalutionMobileApp extends StatefulWidget {
  const RentalutionMobileApp({
    super.key,
...
class _RentalutionMobileAppState extends State<RentalutionMobileApp> {
  ...
  Widget _buildHome() {
    ...
    return HomeScreen(
      ...
      onOpenPasswordReset: _openPasswordReset,
