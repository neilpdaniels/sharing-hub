...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _maybeAutoLaunchBiometricLogin();
    });
  }
  ...
  Future<void> _maybeAutoLaunchBiometricLogin() async {
  ...
  Future<void> _openPasswordReset() async {
    ...
    if (onOpenPasswordReset == null || widget.busy) {
      return;
    }
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                TextButton(
                  onPressed: widget.busy ? null : _openPasswordReset,
