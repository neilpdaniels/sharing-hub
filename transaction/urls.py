...
urlpatterns = [
    ...
    path('admin/rentalution-payments/', views.rentalution_payments_summary, name='rentalution_payments_summary'),
    path('admin/payments/<str:transaction_reference>/', views.admin_transaction_payment_summary, name='admin_transaction_payment_summary'),
